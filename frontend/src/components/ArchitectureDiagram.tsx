  ...
  return (
    <div style={{ fontFamily: "inherit" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 0, marginBottom: "1rem" }}>
        ...
        <Node style={greenNode} main="MCP Server" sub="20 tools" />
      </div>
      ...
      >
        ...
        <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
          ...
          <Node style={redNode} main="Atlas Search + $rankFusion" sub="hybrid recall" />
          <Node style={orangeNode} main="Voyage $rerank" sub="native reranking" />
